...
'},',
'{',
'\tname: \'PNL_SCANCODE_CONSUMO\',',
'\tsrc: new A5.PanelCard({',
'\ttheme: \'iOS7\',',
'\tbody: {',
'\t\tcontent: {',
'\t\t\ttype: \'html\',',
'\t\t\tsrc: \'<div class="A5CWLayout" style="width: " >\\n\\t<div id="{UXPRERENDEREDALIAS}.V.R1.STATICTEXT_13" title=""  class="" style="box-sizing: border-box; -moz-box-sizing: border-box; -ms-box-sizing: border-box; -webkit-box-sizing: border-box;"   >CONSUMO</div>\\n</div><br  style="clear:both; " />\\n<div style="clear: both; font: 0px arial; height: 0px; width: 0px;"></div>\'',
'\t\t},',
'\t\tscroll: {',
'\t\t\taxis: \'both\',',
'\t\t\tstopPropogation: false,',
...
'\toverlay: {',
'\t},',
'\tonSize: function() {if(typeof {UXPRERENDEREDALIAS}_DlgObj != \'undefined\' && typeof {UXPRERENDEREDALIAS}_DlgObj._panelCardResize != \'undefined\') { {UXPRERENDEREDALIAS}_DlgObj._panelCardResize(\'PNL_SCANCODE_CONSUMO\'); };}',
'})',
'},',
'{',
'\tname: \'PNL_REWARDS\',',
...
'\tfooter: {',
'\t\tshow: true,',
'\t\thtml: \'<div style="display:table; margin:auto;"><div \\tid="{UXPRERENDEREDALIAS}.V.R1.NOFLOAT_2"    \\t\\t\\tclass=""  style="height: 56px; max-width: 520px; "  > <div class="A5CWLayout  grey darken-4" style="width: 18%" > \\t<button type="button" id="{UXPRERENDEREDALIAS}.V.R1.BUTTON_3"    ></button> </div> <div class="A5CWLayout  grey darken-4" style="width: 18%" > \\t<button type="button" id="{UXPRERENDEREDALIAS}.V.R1.BUTTON_4"    ></button> </div> <div class="A5CWLayout  grey darken-4 prueba" style="width: 28%" > \\t<button type="button" id="{UXPRERENDEREDALIAS}.V.R1.BUTTON_5"    ></button> </div> <div class="A5CWLayout  grey darken-4" style="width: 18%" > \\t<button type="button" id="{UXPRERENDEREDALIAS}.V.R1.BUTTON_6"    ></button> </div> <div class="A5CWLayout  grey darken-4" style="width: 18%" > \\t<button type="button" id="{UXPRERENDEREDALIAS}.V.R1.BUTTON_7"    ></button> </div><br  style="clear:both; " /> <div style="font: 0pt arial;clear:both;"></div> \\t</div> </div>\',',
...
'\tPNL_SCANCODE_CONSUMO: \'PNL_SCANCODE_CONSUMO\',',
'\tPNL_REWARDS: \'PNL_REWARDS\',',
'\tPNL_ACCOUNT: \'PNL_ACCOUNT\'',
'}',
'{UXPRERENDEREDALIAS}_PanelObj._displayNames = {',
'PNL_HOME : \'PNL_HOME\',PNL_MAP : \'PNL_MAP\',PNL_SCANCODE : \'PNL_SCANCODE\',PNL_SCANCODE_CONSUMO : \'PNL_SCANCODE_CONSUMO\',PNL_REWARDS : \'PNL_REWARDS\',PNL_ACCOUNT : \'PNL_ACCOUNT\',PANELNAVIGATOR_1 : \'PANELNAVIGATOR_1\'',
'};',
...
'\t"__dtfmt": "MM/dd/yyyy",',
'\t"__tfmt": "",',
'\t"__dialogGuid": "9a28cf75-759d-4c71-bf39-10a141977a47",',
...
'QUERYMEMBER_ID:\'PNL_SCANCODE\',',
'QUERYMEMBER_RUT:\'PNL_SCANCODE\',',
'QUERYMEMBER_BDAY:\'PNL_SCANCODE\',',
'QUERYMEMBER_CONSUMO:\'PNL_SCANCODE\'',
'}',
'{UXPRERENDEREDALIAS}_DlgObj._controlsOnPanel = {',
'\t\'PNL_MAP\' : {controls: [\'MAP\']},',
'\t\'PNL_SCANCODE\' : {controls: [\'QUERYMEMBER_NOMBRE\',\'QUERYMEMBER_ID\',\'QUERYMEMBER_RUT\',\'QUERYMEMBER_BDAY\',\'QUERYMEMBER_CONSUMO\']}',
'}',
...
'CONTAINER_6: [\'queryMember_nombre\',\'queryMember_id\'],',
'CONTAINER_7: [],',
'CONTAINER_10: [\'queryMember_RUT\',\'queryMember_bday\'],',
'CONTAINER_8: [\'container:CONTAINER_9\'],',
'CONTAINER_9: [\'queryMember_consumo\'],',
'PANELFOOTER_2: [\'container:NOFLOAT_2\'],',
'NOFLOAT_2: []',
'}',
...
'{UXPRERENDEREDALIAS}_DlgObj.ajaxCallback(\'\',\'\',\'createaccrualtransaction\',\'\',\'\',{deviceOfflineFunction: function() {   }});',
